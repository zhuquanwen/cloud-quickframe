...
package com.iscas.cloud.quickframe.common.bean.aop;


import com.iscas.cloud.quickframe.common.constant.SecurityConstants;
import com.iscas.cloud.quickframe.common.util.UserUtils;
...
public class ControllerAop {
    @Pointcut("execution(public com.iscas.cloud.quickframe.common.util.R *(..))")
