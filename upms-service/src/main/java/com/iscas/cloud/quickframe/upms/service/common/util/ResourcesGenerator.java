...
package com.iscas.cloud.quickframe.upms.service.common.util;
...
public class ResourcesGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/cloud?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        strategy.setSuperControllerClass("com.iscas.cloud.quickframe.common.web.BaseController");
        // 表名生成策略
        ...
        pc.setParent("com.iscas.cloud.quickframe.upms.service");
